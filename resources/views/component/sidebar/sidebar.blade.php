...
<div class="nav-mobile px-6 w-full py-6 lg:hidden sticky top-0 z-50 bg-putihneut2">
    <div class="nav flex gap-3 mb-2">
        ...
        <div class="relative z-10">
            ...
            <button class="hover:bg-slate-200 px-3 py-2 rounded-sm flex gap-2 w-full cursor-pointer" id="openFolderDup"><i class="bi bi-folder"></i>Tambahkan Folder</button>
            <button class="hover:bg-slate-200 px-3 py-2 rounded-sm flex gap-2 w-full cursor-pointer" id="openModalDup"><i class="bi bi-image"></i>Upload Foto</button>
            </div>
